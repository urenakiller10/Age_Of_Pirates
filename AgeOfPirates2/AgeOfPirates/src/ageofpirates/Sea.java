...
public class Sea extends javax.swing.JFrame {
    ...
    public JLabel fondo;
    protected final  ImageIcon beta= new ImageIcon(getClass().getResource("pirata.jpg"));
    ...
    public Sea() {
        ...
        this.fondo=new JLabel(new ImageIcon(getClass().getResource("pirata.jpg")));
        initBoard();  
        setRemolinos();       
        tutorial.start();
...
protected void setRemolinos(){
        ...
        SeaPanelLayout.setHorizontalGroup(
            ...
            .addGroup(SeaPanelLayout.createSequentialGroup()
                .addGroup(SeaPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(SeaPanelLayout.createSequentialGroup()
                        .addGap(101, 101, 101)
                        .addComponent(btnTienda, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(45, 45, 45)
            ...
            .addGroup(SeaPanelLayout.createSequentialGroup()
                .addGroup(SeaPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btnCreateMultipleCanyon, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(SeaPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(SeaPanelLayout.createSequentialGroup()
                            .addGap(387, 387, 387)
                            .addGroup(SeaPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(lbliron, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(lblMoney, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(SeaPanelLayout.createSequentialGroup()
                            .addGap(377, 377, 377)
                            .addComponent(btnCreateCanyon, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnCreateMultipleCanyonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateMultipleCanyonActionPerformed
        if(grafoMatriz.buscarFactory(8)){
            ...
            JOptionPane.showMessageDialog(null, "No existe la armería de cañones multiples");
        }
    ...
    private void btnCreateRedBeardCanyonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateRedBeardCanyonActionPerformed
        if(grafoMatriz.buscarFactory(9)){
            ...
            JOptionPane.showMessageDialog(null, "No existe la armería de cañones barba roja");
        }
    ...
    private void btnCreateBombCanyonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateBombCanyonActionPerformed
        if(grafoMatriz.buscarFactory(10)){
            ...
            JOptionPane.showMessageDialog(null, "No existe la armería de cañones bomba");
        }
